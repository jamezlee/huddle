...
class TopicController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => Topic::find()->orderBy('creationdate DESC'),
            'pagination' => [
                'pageSize' => 10,
            ],
        ]);
    ...
    public function actionView($id)
    {
        ...
        $dataRepliesProvider = new ActiveDataProvider([
            'query' => Replies::find()->where(['topicid'=>$id])->orderBy('creationdate DESC'),
            'pagination' => [
                'pageSize' => 10,
            ],
        ]);
        ...
        return $this->render('view', [
            ...
            'listRepliesProvider' => $dataRepliesProvider,
